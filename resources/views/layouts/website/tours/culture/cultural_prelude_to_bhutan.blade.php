...
<div class="container">
	...
	@endsection
	@section('heading')
		<?php $tour_title = "CULTURAL PRELUDE TO BHUTAN";?>
		<p>{{$tour_title}}</p>
	@endsection
	@section('page_content')
		<div class="col-md-8">
			<img src="{{asset('assets/images/culture/culutural-prelude.jpg')}}" alt="culture tour" width="100%">
			<p>This tour is a prelude to everything that is Bhutan. It provides an overview of Bhutan’s culture and It is ideal for the first time visitor. As a prelude to the cultural richness of Bhutan, visitors will get to meet common people for first-hand experience of rural livelihoods and will also get to stay in countryside cabins to have a taste of laymen’s bucolic existence. Due to the time consuming nature of traversing the country the content of this tour will be structured around the dates in which you intend to stay in the country.</p>
			  			...
			  			<tr>
			  				...
			  				<td>
			  					<table class="table table-bordered">
			  						...
			  						<tbody>
			  							<tr>
			  								<td>USD $ 3813 per person</td>
			  								<td>USD $ 3163 per person</td>
			  							</tr>
			  							<tr>
			  								<td>USD $ 3683 per pax for 2 person</td>
			  								<td>USD $ 3033per pax for 2 person</td>
			  							</tr>
			  							<tr>
			  								<td>USD $ 3293 per pax for 3 person and above</td>
			  								<td>USD $ 2643 per pax for 3 person and above</td>
			  							</tr>
			  						</tbody>
			  					</table>
			  				</td>
			  ...
			  <div class="tab-pane fade" id="detail" role="tabpanel" aria-labelledby="detail-tab" style="margin: 0;">
			  	<div class="panel-group" id="accordion">
			  		...
			  		<div class="panel panel-info">
			  			<div class="panel-heading">
			  				<div class="panel-title">
			  					<a href="#day8" data-toggle="collapse" data-parent="accordion">Day 8 [Bumthang]</a>
			  				</div>
			  			</div>
			  			<div class="panel-collapse collapse" id="day8">
			  				<div class="panel-body">
			  					<ul>
			  						<li>Day excursion to Ura Valley over Shertangla.</li>
			  						<li>Hike to Ura Village.</li>
			  						<li>Visit Ura Monastery and Farmhouse.</li>
			  					</ul>
			  				</div>
			  			</div>
			  		</div>
			  		<div class="panel panel-info">
			  			<div class="panel-heading">
			  				<div class="panel-title">
			  					<a href="#day9" data-toggle="collapse" data-parent="accordion">Day 9 [Bumthang-Phobjikha]</a>
			  				</div>
			  			</div>
			  		...
			  		<div class="panel panel-info">
			  			<div class="panel-heading">
			  				<div class="panel-title">
			  					<a href="#day10" data-toggle="collapse" data-parent="accordion">Day 10 [Phobjikha-Punakha]</a>
			  				</div>
			  			</div>
			  		...
			  		<div class="panel panel-info">
			  			<div class="panel-heading">
			  				<div class="panel-title">
			  					<a href="#day11" data-toggle="collapse" data-parent="accordion">Day 11 [Punakha-Paro]</a>
			  				</div>
			  			</div>
			  		...
			  		<div class="panel panel-info">
			  			<div class="panel-heading">
			  				<div class="panel-title">
			  					<a href="#day12" data-toggle="collapse" data-parent="accordion">Day 12 [Paro]</a>
			  				</div>
			  			</div>
			  		...
			  		<div class="panel panel-info">
			  			<div class="panel-heading">
			  				<div class="panel-title">
			  					<a href="#day13" data-toggle="collapse" data-parent="accordion">Day 13 [Departure]</a>
			  				</div>
			  			</div>
